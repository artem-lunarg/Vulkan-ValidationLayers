...
class CommandBufferContext final : public ResourceUsageInfoProvider, public DebugNameProvider {
  public:
    ...
    ResourceUsageTag RecordBeginRenderPass(vvl::Func command, std::shared_ptr<const vvl::RenderPass> rp_state,
    ...
    void AddReplayAction(ResourceUsageTag tag, std::unique_ptr<ReplayAction>&& action);
    void AddEventAction(ResourceUsageTag tag, std::unique_ptr<ReplayAction>&& action);
    void AddContextUpdate(ResourceUsageTag tag, ContextUpdate context_update,
