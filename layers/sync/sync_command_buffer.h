...
class CommandBufferContext final : public ResourceUsageInfoProvider, public DebugNameProvider {
  public:
    ...
    VertexInputAccesses CollectVertexAccesses(uint32_t vertex_count, uint32_t first_vertex) const;
    VertexInputAccesses CollectIndexAccesses(uint32_t index_count, uint32_t first_index) const;
