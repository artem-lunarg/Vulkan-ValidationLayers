...
class SyncValidator : public ValidationStateTracker, public SyncStageAccess {
  public:
    ...
    bool PropagateTimelineSignals(SignalsUpdate &signals_update, PresentedImages &presented_images,
                                  const ErrorObject &error_obj) const;

    // Return true if new timeline signals were generated by resolved batches
    bool ProcessUnresolvedBatches(std::vector<UnresolvedQueue> &queues, SignalsUpdate &signals_update,
                                  PresentedImages &presented_images, bool &skip, const ErrorObject &error_ob) const;
    ...
    bool PreCallValidateQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR *pPresentInfo,
                                        const ErrorObject &error_obj) const override;
    void RecordQueuePresent(QueueSubmitCmdState *cmd_state);
