...
// NOTE: That's for use cases when BarrierScope does not use a tag (record time and non-event barriers).
// A queue can be provided when replay applies render pass layout transitions.
