...
class ErrorMessages {
  public:
    ...
    std::string BufferError(const SyncEnvironment& env, const HazardResult& hazard, vvl::Func command,
    ...
    std::string ImageClearError(const SyncEnvironment& env, const HazardResult& hazard, vvl::Func command,
                                const std::string& resource_description, uint32_t subresource_range_index,
                                const VkImageSubresourceRange& subresource_range, AdditionalMessageInfo additional_info = {}) const;
